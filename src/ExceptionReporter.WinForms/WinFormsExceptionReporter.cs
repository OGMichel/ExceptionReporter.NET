...
namespace ExceptionReporting
{
  ...
  /// </summary>
  public class WinFormExceptionReporter : ExceptionReporterBase
  {
	/// <summary>
	/// Initialise the ExceptionReporter
	/// </summary>
	public WinFormExceptionReporter()
	{
	...
	/// </summary>
	/// <remarks>The <see cref="WinFormExceptionReporter"/> will analyze the <see cref="Exception"/>s and 
