...
namespace ExceptionReporting.WPF.MvvM.ViewModel
{
  public class ExceptionReporterViewModel : ObservableObject
  {
	...
	{
	  get { return _copyCommand ??= new RelayCommand(_ => Copy(), _ => true); }
	}

	public ICommand EmailCommand
	{
	  get { return _emailCommand ??= new RelayCommand(_ => SendEmail(), _ => true); }
	}

	public ICommand ShowDetailsCommand
	{
	  get { return _showDetailsCommand ??= new RelayCommand(_ => ShowDetails(), _ => true); }
	}
