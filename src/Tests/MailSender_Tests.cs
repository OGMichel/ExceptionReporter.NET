...
namespace ExceptionReporting.Tests
{
	public class MailSender_Tests
	{
		...
		public void Can_Create_Subject()
		{
			...
			var mailSender = new DefaultMailSender(reportInfo, null, new Mock<IScreenShooter>().Object);
		...
		{
			var mailSender = new DefaultMailSender(new ExceptionReportInfo(), null, new Mock<IScreenShooter>().Object);       // no exceptions set, so message will be null, does mail cater for it?
